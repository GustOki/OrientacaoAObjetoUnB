from package.maths.terms import FigsGeom, coordUnique, Square, Polygon, Circle, Hexagon, Line, Losango, Pentagon, Point, Rectangle, TrapezioIsosceles, TrapezioRetangulo, TriangleEquil, TriangleEscaleno, TriangleIsos
